"""Conversation summarization example — multi-turn chat with dual-cursor summarization.

Demonstrates how to implement progressive conversation summarization
using existing sherma declarative features (call_llm, set_state,
conditional edges, interrupt).

Usage:
    uv run python examples/conversation_summarization/main.py "Hello!"
...
async def main() -> None:
    ...
    for name in ("httpcore", "httpx", "celpy", "openai"):
